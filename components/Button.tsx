...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantStyles = {
    ...
    secondary: 'bg-secondary hover:bg-secondary-dark text-neutral-800 focus:ring-secondary',
    danger: 'bg-red-600 hover:bg-red-700 text-white focus:ring-red-500',
    outline: 'border border-primary text-primary hover:bg-primary-light hover:text-white focus:ring-primary',
    ghost: 'bg-transparent hover:bg-neutral-200 text-neutral-700 focus:ring-primary',
  };
